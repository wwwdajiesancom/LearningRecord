...
<body>
	...
	<a href="#" class="easyui-linkbutton" tag="dialog" buttons="save,close" params="modal:true;width:350px;height: 250px;href:${contextPath}/jsp/dialog/view.html;">动态创建一个dialog</a>
	
	<a href="#" class="easyui-linkbutton" id="open_dialog" >打开本页面的dialog</a>
	
 	<div id="test_dialog" class="easyui-dialog" title="对话框2" modal="true" buttons="#bt" style="width: 350px;height: 250px;">
